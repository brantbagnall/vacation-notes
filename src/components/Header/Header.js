        ...
        return (
            <div className='header-main' >
                ...
                <div>
                    ...
                    <a href={process.env.REACT_APP_PROFILE ? process.env.REACT_APP_PROFILE : 'http://localhost:3005/profile' } ><button className={this.props.profile.user_id ? 'header-button-enabled': 'header-button-disabled'} >
                        Profile
                    </button></a>
